import pandas as pd
import os
from src.config import DATA_FILE, TARGET_COL, PROVIDERS_FILE
    ...
    def load_data(self):
        ...
        try:
            ...
            if os.path.exists(PROVIDERS_FILE):
                self.provider_filter = ProviderFilter(PROVIDERS_FILE, DATA_FILE)
            else:
                print(f"[ALERT] Fichier des prestataires non trouve : {PROVIDERS_FILE}")
